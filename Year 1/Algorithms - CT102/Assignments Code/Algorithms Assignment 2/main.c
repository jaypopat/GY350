...
int mergeSort_recursiveCalls=0;
int quickSort_recursiveCalls=0;
...
int main(){
    ...
    printf("%d ,merge sort data moves\n",mergeSortComparisons);
    printf("%d ,recursive calls merge sort\n",(mergeSort_recursiveCalls-1));
    ...
    printf("%d ,recursive calls quick sort\n",(quickSort_recursiveCalls-1));
}
void printArray(int A[], int size)
{
    int i;
